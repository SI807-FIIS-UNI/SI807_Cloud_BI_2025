# Informe General del Proyecto Final
...
1. **Configuración Inicial del Entorno**
   ...
   📁 [`1_Entorno/README.md`](ExFinal/Proceso/1_Entorno/README.md)
...
2. **Configuración de Seguridad e IAM**
   ...
   📁 [`2_Seguridad/README.md`](ExFinal/Proceso/2_Seguridad/README.md)

3. **Extracción de Datos y Carga al Data Lake**
   Obtención de archivos CSV y carga inicial en Cloud Storage (capa Bronce).

   📁 [`3_Extracción/README.md`](ExFinal/Proceso/3_Extracción/README.md)
...
4. **Transformación de Datos y Procesamiento con Dataproc**
   ...
   📁 [`4_Transformacion/README.md`](ExFinal/Proceso/4_Transformacion/README.md)
...
5. **Carga a BigQuery y Construcción de KPIs**
   ...
   📁 [`5_Carga/README.md`](ExFinal/Proceso/5_Carga/README.md)
...
6. **Orquestación del Proceso ETL**
   ...
   📁 [`6_Orquestacion/README.md`](ExFinal/Proceso/6_Orquestacion/README.md)
...
7. **Visualización y Análisis en Power BI**
   ...
   📁 [`7_Visualizacion/README.md`](ExFinal/Proceso/7_Visualizacion/README.md)
