...
1. Entramos a la consola de Google Cloud  
   <img src="../Media/Fotos/Pruebas/01.png" width="600"/>

2. Entramos a la terminal  
   <img src="../Media/Fotos/Pruebas/02.png" width="600"/>

3. Creamos un archivo Python para ejecutar el código de creación de buckets  
   ```
   nano crear_buckets.py
   ```  
   <img src="../Media/Fotos/Pruebas/03.png" width="600"/>

4. Luego vemos esta pantalla:  
   <img src="../Media/Fotos/Pruebas/04.png" width="600"/>
...
5. Pegamos el código correspondiente en el archivo 
   ...
   <img src="../Media/Fotos/Pruebas/05.png" width="600"/>

6. Guardamos con **CTRL + O**, luego **ENTER** y salimos con **CTRL + X**  
   <img src="../Media/Fotos/Pruebas/06.png" width="600"/>

7. Ejecutamos el script con:  
   ```
    python3 crear_buckets.py
    ``` 
   <img src="../Media/Fotos/Pruebas/07.png" width="600"/>

8. ¡Listo! Bucket creado con sus carpetas correspondientes  
   <img src="../Media/Fotos/Pruebas/08.png" width="600"/>
...
1. Entramos a la carpeta **bronce** en Cloud Storage  
   <img src="../Media/Fotos/Pruebas/09.png" width="600"/>

2. Seleccionamos **Subir** → **Subir Archivos**  
   <img src="../Media/Fotos/Pruebas/10.png" width="600"/>

3. Elegimos los archivos a subir y hacemos clic en **Abrir**  
   <img src="../Media/Fotos/Pruebas/11.png" width="600"/>

4. ¡Y listo!  
   <img src="../Media/Fotos/Pruebas/12.png" width="600"/>
