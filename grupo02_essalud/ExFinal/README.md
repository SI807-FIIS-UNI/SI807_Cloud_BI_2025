...
1. **Configuración Inicial del Entorno**
   ...
   📁 [`1_Entorno/README.md`](Proceso/1_Entorno/README.md)
...
4. **Transformación de Datos y Procesamiento con Dataproc**
   ...
   📁 [`4_Transformacion/README.md`](Proceso/4_Transformacion/README.md)
...
5. **Carga a BigQuery y Construcción de KPIs**
   ...
   📁 [`5_Carga/README.md`](Proceso/5_Carga/README.md)
...
6. **Orquestación del Proceso ETL**
   ...
   📁 [`6_Orquestacion/README.md`](Proceso/6_Orquestacion/README.md)
...
7. **Visualización y Análisis en Power BI**
   ...
   📁 [`7_Visualizacion/README.md`](Proceso/7_Visualizacion/README.md)
