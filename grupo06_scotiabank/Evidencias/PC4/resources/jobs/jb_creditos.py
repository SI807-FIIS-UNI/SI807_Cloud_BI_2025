...
# Totales mensuales del sistema financiero
df_totales = (
...
# -----------------------------
# Unión con dimensión fecha
# -----------------------------
df_fecha = spark.table("oro.dim_fecha").select("id_fecha", "anio", "mes")
...
df_final = df_ratio.select(
    F.col("id_banco"),
    F.col("id_fecha"),
    lit(ID_MONEDA).alias("id_moneda"),
    lit(ID_INDICADOR).alias("id_indicador"),
    lit(ID_LIMITE).alias("id_limite"),
